...
class Task(models.Model):
    ...
    team_coordinators = models.ManyToManyField(Members,blank=True,related_name="team_coordinators")
    members = models.ManyToManyField(Members,blank=True,related_name="team_members")
