...
urlpatterns = [
    ...
    #task history
    path('individual_task_history/<int:ieee_id>',views.individual_task_history,name="individual_task_history"),
    path('team_task_history/<int:team_primary>',views.team_task_history,name="team_task_history"),
    ##
