    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', django_resized.forms.ResizedImageField(crop=None, default='Admin/admin_profile_pictures/default_profile_picture.png', force_format=None, keep_meta=True, quality=80, scale=1.0, size=[1920, 1080], upload_to='Admin/admin_profile_pictures/')),
